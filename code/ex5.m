...
% do exercício.
% Este arquivo nâo deve ser alterado.
%
...
debug = 0; % Para mostrar ou nâo os resultados da classificação das imagens
...
%% === Parte 2a: Testando implementação da função custo (sem regularização) ====
%  
%
fprintf('\nFunção de custo (sem regularização)...\n')

lambda = 0; % Desconsidera a regularização
